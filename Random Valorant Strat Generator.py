...
def VSR():
    ...
    strat_attack2 = ["rush C", "go garage into C", "peek mid window", "rush B", "group attack A", "rush A", "group attack B", "go mid", "play for picks", "play default"]
    ...
    player_map = input("\nWhat map are you playing? ").lower()
